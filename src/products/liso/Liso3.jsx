...
import liso3 from "../../assets/imgs/cabelosLisos/cabelo_liso_vietna_castanho_natural_60cm.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Liso3() {
  return (
    <section className={styles.containerProduct}>
      ...
      <div className={styles.descriptionProduct}>
        ...
        <div className={styles.imgProduct}>
          <img src={liso3} alt="CABELO LISO ONDULADO 55CM CASTANHO NATURAL" />
        </div>
        <div className={styles.description}>
          <h3>TOP HAIR SSA</h3>
          <p>Origem: Humano</p>
          <p>Cabelo liso, virgem, castanho natural.</p>
          <p>
