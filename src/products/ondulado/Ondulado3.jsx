...
import ondulado3 from "../../assets/imgs/cabelosOndulados/cabelo_liso_e_ondulado_65cm_castanho_natural.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Ondulado3() {
  return (
    <section className={styles.containerProduct}>
      <a href="../pages/ondulado.html" class="backPage">
