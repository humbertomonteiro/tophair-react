...
import brasilRegiLiso from "../../assets/imgs/cabelosBrasileirosRegional/cabelo_brasileiro_regional_50cm_liso_ou_ondulado.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function BrasileiroReg1() {
  return (
    <section className={styles.containerProduct}>
      <div className={styles.descriptionProduct}>
        <h2>CABELO BRASILEIRO REGIONAL 50CM LISO OU ONDULADO</h2>
        <div className={styles.imgProduct}>
          <img
            src={brasilRegiLiso}
            alt="CABELO BRASILEIRO REGIONAL 50CM LISO OU ONDULADO"
          />
        </div>
