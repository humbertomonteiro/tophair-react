...
import brasilCastanho100g from "../../assets/imgs/cabelosBrasileiro/cabelo_brasileiro_castanho_do_sul_fio_fino_100grs_70cm.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Brasileiro6() {
  return (
    <section className={styles.containerProduct}>
      ...
      <div className={styles.descriptionProduct}>
        <h2>CABELO BRASILEIRO DO SUL DESCOLORIDO LINHA LUXO 60/65CM 100GRS</h2>
        <div className={styles.imgProduct}>
          <img
            src={brasilCastanho100g}
            alt="CABELO BRASILEIRO DO SUL DESCOLORIDO LINHA LUXO"
          />
        </div>
