...
import brasilDoSulLoiro from "../../assets/imgs/cabelosBrasileiro/cabelo_brasileiro_loiro_natural_do_sul_fio_fino_100grs_loiro_virgem_60cm.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Brasileiro2() {
  return (
    <section className={styles.containerProduct}>
      ...
      <div className={styles.descriptionProduct}>
        <h2>
          CABELO BRASILEIRO LOIRO NATURAL DO SUL FIO FINO 100GRS LOIRO VIRGEM
          50CM
        </h2>
        <div className={styles.imgProduct}>
          <img
            src={brasilDoSulLoiro}
            alt="CABELO BRASILEIRO LOIRO NATURAL DO SUL FIO FINO"
          />
        </div>
