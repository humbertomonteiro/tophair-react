...
import brasilDoSulFioFino100g from "../../assets/imgs/cabelosBrasileiro/cabelo_brasileiro_castanho_do_sul_fio_fino_100grs_60cm.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Brasileiro5() {
    return (
    ...
    <h2>CABELO BRASILEIRO CASTANHO DO SUL FIO FINO 100GRS 70CM</h2>
        <div className={styles.imgProduct}>
            <img src={brasilDoSulFioFino100g} alt="CABELO BRASILEIRO CASTANHO DO SUL FIO FINO" />
        </div>
        <div className={styles.description}>
            <h3>
                CABELO BRASILEIRO DO SUL
            </h3>
            <p>
                Tom: Castanho
            </p>
            ...
            <p>
                O cabelo do brasileiro do Sul está literalmente bombando!

                Ele é um cabelo de fio fino, cortado de uma única só cabeça de 
                crianças e ou mulheres adultas.

                Os cabelos são 100% naturais. Ele é um cabelo leve e sedoso, e 
                tem um brilho radiante.

                Não embaraça depois de aplicado na cabeça, independente da técnica 
                que foi usada para colocação.
            ...
            <p>
                Sabe aquelas artistas que você assiste filme ou novela, e você 
                fica simplesmente apaixonada pelos cabelos?

                Normalmente elas estão usando um cabelo <strong>brasileiro 
                    do Sul</strong>, e fica tão natural e parecidos com os delas 
                    que você nem percebe que elas estão usando.
            </p>
            ...
            <p>
                ...
                melhor satisfação dos nossos clientes, (lembrando que esse serviço 
                é um valor a parte, NÃO está incluso no valor do cabelo), caso a 
            ...
            <h3>DICAS PARA VOCÊ FICAR AINDA MAIS LINDA COM O CABELO BRASILEIRO</h3>
            <p>Hidrate seu cabelo</p>
            <p>
                Hidratar o cabelo é importante para mantê-lo bonito e saudável, e 
                nos casos dos 
                cabelos compridos ela é indispensável.
            </p>
            <p>
            ...
            <p>
                Portanto nunca (nunquinha mesmo) durma com os cabelos molhados!
            </p>
            <p>
                Evite prender o cabelo ainda úmido, e nem pensar em prender molhado.
            </p>
            <p>
                O melhor é deixar o cabelo respirar e lavar sempre nas primeiras horas 
                do dia com água fria, seu cabelo agradece!
            </p>
            <Boxes />
            <h3>IMPORTANTE:</h3>
            <p>
                <ul>
                    ...
                    <li>
                        <p>
                            Os produtos devolvidos serão submetidos à analise 
                            por técnicos especializados.
                        </p>
                    </li>
                    <li>
                        <p>
                            O produto adquirido será enviado a partir de fios 
                            de maior proximidade em cor e comprimento
                        </p>
                    </li>
                </ul>
            </p>
