...
import brasilDoSulCastanhoFF from "../../assets/imgs/cabelosBrasileiro/cabelo_brasileiro_castanho_do_sul_fio_fino_100grs_50cm_copia.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Brasileiro8() {
  return (
    <section className={styles.containerProduct}>
      ...
      <div className={styles.descriptionProduct}>
        ...
        <div className={styles.imgProduct}>
          <img
            loading="lazy"
            src={brasilDoSulCastanhoFF}
            alt="CABELO BRASILEIRO DO SUL MORENA ILUMINADA LINHA LUXO"
          />
        </div>
