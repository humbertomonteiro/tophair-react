...
import brasilDoSulFioFino from "../../assets/imgs/cabelosBrasileiro/cabelo_brasileiro_castanho_do_sul_fio_fino_100grs_50cm.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Brasileiro4() {
  return (
    <section className={styles.containerProduct}>
      ...
      <div className={styles.descriptionProduct}>
        <h2>CABELO BRASILEIRO CASTANHO DO SUL FIO FINO 100GRS 60CM</h2>
        <div className={styles.imgProduct}>
          <img
            loading="lazy"
            src={brasilDoSulFioFino}
