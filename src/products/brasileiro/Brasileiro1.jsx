...
import brasilDoSul from "../../assets/imgs/cabelosBrasileiro/cabelo_brasileiro_do_sul_morena_iluminada_linha_luxo_60_65cm_100grs.webp";

import BtnWhatsapp from "../../components/BtnWhatsapp";

import Boxes from "../../components/Boxes";

export default function Brasileiro1() {
  return (
    <section className={styles.containerProduct}>
      <a href="../pages/brasileiros.html" className={styles.buttonBack}>
        <i className="fa-solid fa-angle-left"></i>
      </a>
      <div className={styles.descriptionProduct}>
        <h2>
          CABELO BRASILEIRO DO SUL MORENA ILUMINADA LINHA LUXO 60/65CM 100GRS
        </h2>
        ...
        <div className={styles.imgProduct}>
          <img
            loading="lazy"
            src={brasilDoSul}
            alt="CABELO BRASILEIRO DO SUL MORENA ILUMINADA"
          />
        </div>
        ...
        <div className={styles.description}>
          ...
          <ul>
            ...
            <li>Cabelo liso que é somente lavar e já está maravilhos</li>
            <li>Sem precisar se preocupar com chapinha ou escov</li>
            <li>
